show_cpu() {
  ...
  index=$1
  icon=$(get_tmux_batch_option "@tmux_theme_cpu_icon" "")
  color="$(get_tmux_batch_option "@tmux_theme_cpu_color" "#{cpu_bg_color}")"
  text="$(get_tmux_batch_option "@tmux_theme_cpu_text" "#{cpu_percentage}")"
